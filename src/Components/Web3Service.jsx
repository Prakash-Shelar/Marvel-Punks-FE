...
const Web3Service = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!window.ethereum || !window.ethereum.selectedAddress) {
      alert('Please install MetaMask and connect your wallet to use this feature.');
      return;
    }
    ...
    if (!WalletAddress || !WalletAddress.address) {
      ...
      try {
        ...
        if (randomNftResponse.data) {
          const metadata = [];
          randomNftResponse.data.forEach((element) => {
            metadata.push({
              id: element._id,
          ...
          setNft(
            randomNftResponse.data.map((element) => {
  ...
  return { nft, setNftCount, setNft, setError, minting, error, handleSubmit };
}
